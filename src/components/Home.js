    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', scrollBehavior: 'smooth' }}>
            <div className='homeBackground'>
                ...
                <Link to='/mapper' style={{ width: '30%', display: 'flex', justifyContent: 'flexStart', alignItems: 'center', flexDirection: 'column', textDecoration: 'none' }}>
                    <img src={sidearrow} style={{ width: '40%', marginTop: '150px' }} />
